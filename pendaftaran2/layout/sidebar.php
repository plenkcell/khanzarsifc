        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <?php } ?>
                    <li>
                        <a href="regis_booking.php">
                            <i class="material-icons">person_add</i>
                            <span>Booking</span>
                        </a>
                    </li>
                    <li>
                        <a href="riwayat-booking.php">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2017 - <?php echo date('Y'); ?> <a href="#" data-toggle="modal" data-target="#ICTRSHD">Instalasi IT RSUD Kota Depok</a>.
                </div>
            </div>
            <!-- #Footer -->
        </aside>
