...
public final class DlgRanapPerRuang extends javax.swing.JDialog {
    ...
    private int i=0,jmlpasien=0,ttljmlpasien=0,jmlhari=0,ttljmlhari=0,jmlharikls1=0,ttljmlharikls1=0,jmlharikls2=0,ttljmlharikls2=0,jmlharikls3=0,ttljmlharikls3=0,jmlhariklsvip=0,ttljmlhariklsvip=0,jmlharivvip=0,ttljmlharivvip=0;
    ...
    public DlgRanapPerRuang(java.awt.Frame parent, boolean modal) {
        ...
        setSize(885,674);
        tabMode=new DefaultTableModel(null,new String[]{"No.","Ruangan","Jumlah Pasien","Hari Perawatan","Kelas 1","Kelas 2","Kelas 3","Kelas VIP","Kelas VVIP"}){
        ...
        tabMode2=new DefaultTableModel(null,new String[]{"No.","Ruangan","Jumlah Pasien","Hari Perawatan","Kelas 1","Kelas 2","Kelas 3","Kelas VIP","Kelas VVIP"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    public void tampil(){        
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement(
                        ...
                        "and kamar.kd_bangsal=? and reg_periksa.kd_pj like ? ");
                    try {
        ...
        ///////// start kls1           
                    ...
                    ps2=koneksi.prepareStatement(
                        ...
                        "on reg_periksa.no_rawat=kamar_inap.no_rawat and kamar_inap.kd_kamar=kamar.kd_kamar  "+
                        "where reg_periksa.status_lanjut='Ranap' and reg_periksa.tgl_registrasi between ? and ? "+
                        "and kamar.kd_bangsal=? and reg_periksa.kd_pj like ? AND kamar.kelas IN ('kelas 1')");
                    try {
                        ps2.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                        ps2.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                        ps2.setString(3,rs.getString(1));
                        ...
                        rs2=ps2.executeQuery();
                        if(rs2.next()){
                            jmlharikls1=rs2.getInt(1);
                            ttljmlharikls1=ttljmlharikls1+rs2.getInt(1);
                        }
                    } catch (Exception e) {
                        System.out.println("Notif : "+e);
                    } finally{
        ...
        ///////// start kls2          
                    ...
                    ps2=koneksi.prepareStatement(
                        ...
                        "on reg_periksa.no_rawat=kamar_inap.no_rawat and kamar_inap.kd_kamar=kamar.kd_kamar  "+
                        "where reg_periksa.status_lanjut='Ranap' and reg_periksa.tgl_registrasi between ? and ? "+
                        "and kamar.kd_bangsal=? and reg_periksa.kd_pj like ? AND kamar.kelas IN ('kelas 2')");
                    try {
                        ps2.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                        ps2.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                        ps2.setString(3,rs.getString(1));
                        ...
                        rs2=ps2.executeQuery();
                        if(rs2.next()){
                            jmlharikls2=rs2.getInt(1);
                            ttljmlharikls2=ttljmlharikls2+rs2.getInt(1);
                        }
                    } catch (Exception e) {
                        System.out.println("Notif : "+e);
                    } finally{
        ...
        ///////// start kls3        
                    ...
                    ps2=koneksi.prepareStatement(
                        ...
                        "on reg_periksa.no_rawat=kamar_inap.no_rawat and kamar_inap.kd_kamar=kamar.kd_kamar  "+
                        "where reg_periksa.status_lanjut='Ranap' and reg_periksa.tgl_registrasi between ? and ? "+
                        "and kamar.kd_bangsal=? and reg_periksa.kd_pj like ? AND kamar.kelas IN ('kelas 3')");
                    try {
                        ps2.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                        ps2.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                        ps2.setString(3,rs.getString(1));
                        ...
                        rs2=ps2.executeQuery();
                        if(rs2.next()){
                            jmlharikls3=rs2.getInt(1);
                            ttljmlharikls3=ttljmlharikls3+rs2.getInt(1);
                        }
                    } catch (Exception e) {
                        System.out.println("Notif : "+e);
                    } finally{
        ...
        ///////// start klsvip       
                    ...
                    ps2=koneksi.prepareStatement(
                        ...
                        "on reg_periksa.no_rawat=kamar_inap.no_rawat and kamar_inap.kd_kamar=kamar.kd_kamar  "+
                        "where reg_periksa.status_lanjut='Ranap' and reg_periksa.tgl_registrasi between ? and ? "+
                        "and kamar.kd_bangsal=? and reg_periksa.kd_pj like ? AND kamar.kelas IN ('kelas VIP','Kelas Utama')");
                    try {
                        ps2.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                        ps2.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                        ps2.setString(3,rs.getString(1));
                        ...
                        rs2=ps2.executeQuery();
                        if(rs2.next()){
                            jmlhariklsvip=rs2.getInt(1);
                            ttljmlhariklsvip=ttljmlhariklsvip+rs2.getInt(1);
                        }
                    } catch (Exception e) {
                        System.out.println("Notif : "+e);
                    } finally{
        ...
        ///////// start klsvvip       
                    ...
                    ps2=koneksi.prepareStatement(
                        ...
                        "on reg_periksa.no_rawat=kamar_inap.no_rawat and kamar_inap.kd_kamar=kamar.kd_kamar  "+
                        "where reg_periksa.status_lanjut='Ranap' and reg_periksa.tgl_registrasi between ? and ? "+
                        "and kamar.kd_bangsal=? and reg_periksa.kd_pj like ? AND kamar.kelas IN ('kelas VVIP')");
                    try {
                        ps2.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                        ps2.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                        ps2.setString(3,rs.getString(1));
                        ...
                        rs2=ps2.executeQuery();
                        if(rs2.next()){
                            jmlharivvip=rs2.getInt(1);
                            ttljmlharivvip=ttljmlharivvip+rs2.getInt(1);
                        }
                    } catch (Exception e) {
                        System.out.println("Notif : "+e);
                    } finally{
        ...
        ///// end klsvvip
                    ...
                    if(jmlpasien>0){
                        tabMode.addRow(new Object[]{
                            i,rs.getString(2),jmlpasien,jmlhari,jmlharikls1,jmlharikls2,jmlharikls3,jmlhariklsvip,jmlharivvip
                        });
                        i++;
                    }                        
                }
                if(ttljmlhari>0){
                    tabMode.addRow(new Object[]{
                        "","Jumlah",ttljmlpasien,ttljmlhari,ttljmlharikls1,ttljmlharikls2,ttljmlharikls3,ttljmlhariklsvip,ttljmlharivvip
                    });
                    i++;
                }
            } catch (Exception e) {
