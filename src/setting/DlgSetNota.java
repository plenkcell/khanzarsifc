...
public class DlgSetNota extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtBiayaMinimal = new widget.TextBox();
        label1 = new widget.Label();
        txtBiayaMaximal = new widget.TextBox();
        ...
        txtBiayaMinimalPiutang = new widget.TextBox();
        label2 = new widget.Label();
        txtBiayaMaximalPiutang = new widget.TextBox();
        ...
        FormInput2.setPreferredSize(new java.awt.Dimension(797, 194));
        ...
        jLabel33.setText("Biaya Minimal :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput2.add(jLabel33);
        jLabel33.setBounds(0, 160, 150, 23);
        ...
        jLabel44.setText("Besar Biaya :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput2.add(jLabel44);
        jLabel44.setBounds(0, 42, 150, 23);

        txtBiayaMinimal.setName("txtBiayaMinimal"); // NOI18N
        FormInput2.add(txtBiayaMinimal);
        txtBiayaMinimal.setBounds(153, 160, 160, 24);

        label1.setText("Biaya Maximal :");
        label1.setName("label1"); // NOI18N
        FormInput2.add(label1);
        label1.setBounds(330, 160, 100, 20);

        txtBiayaMaximal.setName("txtBiayaMaximal"); // NOI18N
        FormInput2.add(txtBiayaMaximal);
        txtBiayaMaximal.setBounds(433, 160, 190, 24);
        ...
        jLabel45.setText("Biaya Minimal :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput3.add(jLabel45);
        jLabel45.setBounds(0, 160, 150, 23);

        txtBiayaMinimalPiutang.setName("txtBiayaMinimalPiutang"); // NOI18N
        FormInput3.add(txtBiayaMinimalPiutang);
        txtBiayaMinimalPiutang.setBounds(153, 160, 160, 24);

        label2.setText("Biaya Maximal :");
        label2.setName("label2"); // NOI18N
        FormInput3.add(label2);
        label2.setBounds(330, 160, 100, 20);

        txtBiayaMaximalPiutang.setName("txtBiayaMaximalPiutang"); // NOI18N
        FormInput3.add(txtBiayaMaximalPiutang);
        txtBiayaMaximalPiutang.setBounds(433, 160, 190, 24);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TabSetting.getSelectedIndex()==0){
		    ...
		    laborat="Yes";
                ...
                if(Sequel.menyimpantf("set_service_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",19,new String[]{
                    NamaService.getText(),BesarBiaya.getText(),laborat,radiologi,operasi,obat,ranap_dokter,ranap_paramedis,
                    ralan_dokter,ralan_paramedis,tambahan,potongan,kamar,registrasi,harian,retur_Obat,resep_Pulang,txtBiayaMinimal.getText(),txtBiayaMaximal.getText()
                })==true){
                    tampil2();
                    emptTeks2();
                }
		    ...
		    laborat="Yes";
                ...
                if(Sequel.menyimpantf("set_service_ranap_piutang","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",19,new String[]{
                    NamaService1.getText(),BesarBiaya1.getText(),laborat,radiologi,operasi,obat,ranap_dokter,ranap_paramedis,
                    ralan_dokter,ralan_paramedis,tambahan,potongan,kamar,registrasi,harian,retur_Obat,resep_Pulang,txtBiayaMinimalPiutang.getText(),txtBiayaMaximalPiutang.getText()
                })==true){
                    tampil3();
                    emptTeks3();
                }
...
private void NotaRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NotaRalanKeyPressed
    ...
    */
    ...
    private widget.TextBox txtBiayaMaximal;
    private widget.TextBox txtBiayaMaximalPiutang;
    private widget.TextBox txtBiayaMinimal;
    private widget.TextBox txtBiayaMinimalPiutang;
        ...
        try{    
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode2.addRow(new Object[]{"    Biaya Minimal",rs.getString(18)});
                    tabMode2.addRow(new Object[]{"    Biaya Maximal",rs.getString(19)});
                }
            } catch (Exception e) {
                System.out.println(e);
            } finally{
        ...
        try{    
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode3.addRow(new Object[]{"    Biaya Minimal",rs.getString(18)});
                    tabMode3.addRow(new Object[]{"    Biaya Maximal",rs.getString(19)});
                }
            } catch (Exception e) {
                System.out.println(e);
            } finally{
    ...
    private void getData2() {
        ...
        if(row!= -1){
            ...
            txtBiayaMinimal.setText(tbAdmin2.getValueAt(18,1).toString());
            txtBiayaMaximal.setText(tbAdmin2.getValueAt(19,1).toString());
    ...
    private void getData3() {
        ...
        if(row!= -1){
            ...
            txtBiayaMinimalPiutang.setText(tbAdmin3.getValueAt(18,1).toString());
            txtBiayaMaximalPiutang.setText(tbAdmin3.getValueAt(19,1).toString());
        }
    }
    ...
    public void emptTeks2() {
        ...
        chkRetur.setSelected(false);
        chkResepPulang.setSelected(false);
        txtBiayaMinimal.setText(null);
        txtBiayaMaximal.setText(null);
    }
    ...
    public void emptTeks3() {
        ...
        chkRetur1.setSelected(false);
        chkResepPulang1.setSelected(false);
        txtBiayaMinimalPiutang.setText(null);
        txtBiayaMaximalPiutang.setText(null);
    }
    ...
    private void isForm2(){
        if(ChkInput2.isSelected()==true){
            ...
            PanelInput2.setPreferredSize(new Dimension(WIDTH,205));
    ...
    private void isForm3(){
        if(ChkInput3.isSelected()==true){
            ...
            PanelInput3.setPreferredSize(new Dimension(WIDTH,205));
