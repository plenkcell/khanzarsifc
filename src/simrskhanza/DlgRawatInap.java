...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaan=new DefaultTableModel(null,new Object[]{
            ...
            "Respirasi(/menit)","Tinggi(Cm)","Berat(Kg)","GCS(E,V,M)","Keluhan","Objek","Alergi","Asesmen","Plan"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
    ...
    private void initComponents() {
        ...
        jLabel15.setBounds(605, 10, 50, 23);
        ...
        TAlergi.setBounds(658, 10, 245, 23);
        ...
        scrollPane4.setBounds(543, 100, 360, 52);
    ...
    */
    ...
    private void getDataPemeriksaan() {
        if(tbPemeriksaan.getSelectedRow()!= -1){
            ...
            TPenilaian.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),16).toString()); 
    ...
    private void inputObat() {
        ...
        dlgobt.setNoRm(TNoRw.getText(),DTPTgl.getDate(),TNoRM.getText(),TPasien.getText());
        dlgobt.isCek();
        dlgobt.tampil();
