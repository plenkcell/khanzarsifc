...
public class DlgBookingOperasi extends javax.swing.JDialog {
    ...
    public DlgBookingOperasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Kode Operator", "Operator", "Order", "Jenis Operasi", "Lokasi Operasi", "Sudah Marking", "Puasa", "Tgl Puasa", "Pra Bedah", "Pra Anastesi", "Tgl Pra Anastesi",
            "Bedah", "Anastesi","Create Date"
        }) {
            @Override
        ...
        tbObat.setPreferredScrollableViewportSize(new Dimension(500, 300));
    ...
    private void initComponents() {
        ...
        cekPraBedah = new widget.CekBox();
        cekPraAnastesi = new widget.CekBox();
        dlgTglPraAnestesi = new widget.Tanggal();
        jPanel4 = new javax.swing.JPanel();
        cekBedah = new widget.CekBox();
        cekAnastesi = new widget.CekBox();
        label4 = new widget.Label();
        jPanel5 = new javax.swing.JPanel();
        label1 = new widget.Label();
        label2 = new widget.Label();
        cekMarking = new widget.CekBox();
        cekPuasa = new widget.CekBox();
        dlgTglPuasa = new widget.Tanggal();
        jLabel38 = new widget.Label();
        cboLokasiOperasi = new widget.ComboBox();
        jLabel39 = new widget.Label();
        cboJenisOperasi = new widget.ComboBox();
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-05-2020" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-05-2020" }));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(190, 205));
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-05-2020" }));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Kelengkapan"));
        jPanel1.setName("jPanel1"); // NOI18N
        jPanel1.setPreferredSize(new java.awt.Dimension(1000, 225));
        ...
        label3.setText("Assesment Bedah");
        label3.setName("label3"); // NOI18N
        jPanel2.add(label3);
        label3.setBounds(120, 10, 100, 14);

        cekPraBedah.setText("Pra Bedah");
        cekPraBedah.setName("cekPraBedah"); // NOI18N
        jPanel2.add(cekPraBedah);
        cekPraBedah.setBounds(20, 30, 70, 16);

        cekPraAnastesi.setText("Pra Anastesi");
        cekPraAnastesi.setName("cekPraAnastesi"); // NOI18N
        jPanel2.add(cekPraAnastesi);
        cekPraAnastesi.setBounds(130, 30, 80, 16);

        dlgTglPraAnestesi.setForeground(new java.awt.Color(50, 70, 50));
        dlgTglPraAnestesi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-05-2020 13:37:51" }));
        dlgTglPraAnestesi.setDisplayFormat("dd-MM-yyyy HH:mm:ss");
        dlgTglPraAnestesi.setName("dlgTglPraAnestesi"); // NOI18N
        dlgTglPraAnestesi.setOpaque(false);
        dlgTglPraAnestesi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                dlgTglPraAnestesiKeyPressed(evt);
            }
        });
        jPanel2.add(dlgTglPraAnestesi);
        dlgTglPraAnestesi.setBounds(220, 30, 131, 20);

        jPanel1.add(jPanel2);
        jPanel2.setBounds(360, 20, 380, 60);
        ...
        cekBedah.setText("Bedah");
        cekBedah.setName("cekBedah"); // NOI18N
        jPanel4.add(cekBedah);
        cekBedah.setBounds(30, 30, 70, 16);

        cekAnastesi.setText("Anastesi");
        cekAnastesi.setName("cekAnastesi"); // NOI18N
        jPanel4.add(cekAnastesi);
        cekAnastesi.setBounds(100, 30, 90, 16);

        label4.setText("Informed Consen Sudah Lengkap");
        label4.setName("label4"); // NOI18N
        jPanel4.add(label4);
        label4.setBounds(10, 10, 180, 14);

        jPanel1.add(jPanel4);
        jPanel4.setBounds(750, 20, 220, 60);
        ...
        label1.setText("Sudah Marking :");
        label1.setName("label1"); // NOI18N
        jPanel5.add(label1);
        label1.setBounds(10, 10, 90, 20);

        label2.setText("Sudahi Puasa :");
        label2.setName("label2"); // NOI18N
        jPanel5.add(label2);
        label2.setBounds(10, 30, 90, 20);

        cekMarking.setText("Belum");
        cekMarking.setName("cekMarking"); // NOI18N
        cekMarking.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cekMarkingActionPerformed(evt);
            }
        });
        jPanel5.add(cekMarking);
        cekMarking.setBounds(110, 10, 70, 16);

        cekPuasa.setText("Belum");
        cekPuasa.setName("cekPuasa"); // NOI18N
        cekPuasa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cekPuasaActionPerformed(evt);
            }
        });
        jPanel5.add(cekPuasa);
        cekPuasa.setBounds(110, 30, 60, 16);

        dlgTglPuasa.setForeground(new java.awt.Color(50, 70, 50));
        dlgTglPuasa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-05-2020 13:37:51" }));
        dlgTglPuasa.setDisplayFormat("dd-MM-yyyy HH:mm:ss");
        dlgTglPuasa.setName("dlgTglPuasa"); // NOI18N
        dlgTglPuasa.setOpaque(false);
        dlgTglPuasa.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                dlgTglPuasaKeyPressed(evt);
            }
        });
        jPanel5.add(dlgTglPuasa);
        dlgTglPuasa.setBounds(170, 30, 150, 20);

        jPanel1.add(jPanel5);
        jPanel5.setBounds(10, 20, 340, 60);

        FormInput.add(jPanel1);
        jPanel1.setBounds(10, 100, 980, 90);

        jLabel38.setText("Lokasi Operasi :");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(820, 40, 90, 23);

        cboLokasiOperasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "LATERALITY", "MULTIPLE LEVEL", "STRUKTUR MULTIPLE", "TIDK PERLU MARKING" }));
        cboLokasiOperasi.setName("cboLokasiOperasi"); // NOI18N
        cboLokasiOperasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cboLokasiOperasiKeyPressed(evt);
            }
        });
        FormInput.add(cboLokasiOperasi);
        cboLokasiOperasi.setBounds(920, 40, 170, 23);

        jLabel39.setText("Jenis Operasi :");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(830, 10, 80, 23);

        cboJenisOperasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CITO", "ELEKTIF", "SISIPAN" }));
        cboJenisOperasi.setName("cboJenisOperasi"); // NOI18N
        cboJenisOperasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cboJenisOperasiKeyPressed(evt);
            }
        });
        FormInput.add(cboJenisOperasi);
        cboJenisOperasi.setBounds(920, 10, 130, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (Sequel.cariRegistrasi(TNoRw.getText()) > 0) {
                ...
                if (!cboLokasiOperasi.getSelectedItem().equals("TIDK PERLU MARKING") && !cekMarking.isSelected()) {
                    JOptionPane.showMessageDialog(rootPane, "Marking Area harus di centang..!!");
                } else {
                    if (Sequel.menyimpantf("booking_operasi", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "data", 18, new String[]{
                        ...
                        Status.getSelectedItem().toString(), KdDokter.getText(), cboJenisOperasi.getSelectedItem().toString(), cboLokasiOperasi.getSelectedItem().toString(), String.valueOf(cekMarking.isSelected() ? 1 : 0), String.valueOf(cekPuasa.isSelected() ? 1 : 0),cekPuasa.isSelected()? Valid.SetTgl(dlgTglPuasa.getSelectedItem()+"")+" "+dlgTglPuasa.getSelectedItem().toString().substring(11,19):null,
                        String.valueOf(cekPraBedah.isSelected() ? 1 : 0), String.valueOf(cekPraAnastesi.isSelected() ? 1 : 0), cekPraAnastesi.isSelected()?Valid.SetTgl(dlgTglPraAnestesi.getSelectedItem()+"")+" "+dlgTglPraAnestesi.getSelectedItem().toString().substring(11,19):null, String.valueOf(cekBedah.isSelected() ? 1 : 0), String.valueOf(cekAnastesi.isSelected() ? 1 : 0),Valid.DateToString(new Date())
                    }) == true) {
                        tampil();
                        emptTeks();
                    }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            try {                
                    int input = JOptionPane.showConfirmDialog(null, "Apakah anda yakin mau menghapus Jadwal Operasi Ini??", "Hapus Dialog", JOptionPane.OK_CANCEL_OPTION, JOptionPane.ERROR_MESSAGE);
                    if (input == 0) {
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
        ...
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (!cboLokasiOperasi.getSelectedItem().equals("TIDK PERLU MARKING") && !cekMarking.isSelected()) {
                ...
                if (Sequel.mengedittf("booking_operasi", "no_rawat=? and kode_paket=? and tanggal=? and jam_mulai=? and jam_selesai=? and status=? and kd_dokter=?",
                    "no_rawat=?,kode_paket=?,tanggal=?,jam_mulai=?,jam_selesai=?,status=?,kd_dokter=?,jenis_operasi=?,lokasi_operasi=?,is_marking_area=?,is_puasa=?,tgl_puasa=?,is_pra_bedah=?,is_pra_anastesi=?,tgl_pra_anastesi=?,is_bedah=?,is_anastesi=?", 24, new String[]{
                        TNoRw.getText(), KdOperasi.getText(), Valid.SetTgl(DTPTgl.getSelectedItem() + ""),
                        JamMulai.getSelectedItem() + ":" + MenitMulai.getSelectedItem() + ":" + DetikMulai.getSelectedItem(),
                        JamSelesai.getSelectedItem() + ":" + MenitSelesai.getSelectedItem() + ":" + DetikSelesai.getSelectedItem(),
                        Status.getSelectedItem().toString(), KdDokter.getText(), cboJenisOperasi.getSelectedItem().toString(), cboLokasiOperasi.getSelectedItem().toString(), cekMarking.isSelected() ? "1" : "0", cekPuasa.isSelected() ? "1" : "0", cekPuasa.isSelected() ? Valid.SetTgl(dlgTglPuasa.getSelectedItem()+"")+" "+dlgTglPuasa.getSelectedItem().toString().substring(11,19):null,
                        cekPraBedah.isSelected() ? "1" : "0", cekPraAnastesi.isSelected() ? "1" : "0", cekPraAnastesi.isSelected()?Valid.SetTgl(dlgTglPraAnestesi.getSelectedItem()+"")+" "+dlgTglPraAnestesi.getSelectedItem().toString().substring(11,19):null, cekBedah.isSelected() ? "1" : "0",
                        cekAnastesi.isSelected() ? "1" : "0", tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString(),
    ...
    private void MnKamarInapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKamarInapActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (Sequel.cariRegistrasi(TNoRw.getText()) > 0) {
                ...
                kamarinap.emptTeks();
                kamarinap.isCek();
                kamarinap.setNoRm(TNoRw.getText(),TNoRw.getText(),TPasien.getText());
    ...
    private void cekMarkingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cekMarkingActionPerformed
        // TODO add your handling code here:
        if (cekMarking.isSelected()) {
            cekMarking.setText("Ya");
        } else {
            cekMarking.setText("Belum");
        }
    }//GEN-LAST:event_cekMarkingActionPerformed

    private void cekPuasaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cekPuasaActionPerformed
        // TODO add your handling code here:
        if (cekPuasa.isSelected()) {
            cekPuasa.setText("Ya");
        } else {
            cekPuasa.setText("Belum");
        }
    }//GEN-LAST:event_cekPuasaActionPerformed

    private void cboLokasiOperasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cboLokasiOperasiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboLokasiOperasiKeyPressed

    private void dlgTglPuasaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dlgTglPuasaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_dlgTglPuasaKeyPressed

    private void dlgTglPraAnestesiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dlgTglPraAnestesiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_dlgTglPraAnestesiKeyPressed

    private void cboJenisOperasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cboJenisOperasiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboJenisOperasiKeyPressed
    ...
    private widget.ComboBox cboJenisOperasi;
    private widget.ComboBox cboLokasiOperasi;
    private widget.CekBox cekAnastesi;
    private widget.CekBox cekBedah;
    private widget.CekBox cekMarking;
    private widget.CekBox cekPraAnastesi;
    private widget.CekBox cekPraBedah;
    private widget.CekBox cekPuasa;
    private widget.Tanggal dlgTglPraAnestesi;
    private widget.Tanggal dlgTglPuasa;
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "booking_operasi.jenis_operasi,booking_operasi.lokasi_operasi,"
                    + "booking_operasi.is_marking_area,booking_operasi.is_puasa,booking_operasi.tgl_puasa,booking_operasi.is_pra_bedah,booking_operasi.is_pra_anastesi,booking_operasi.tgl_pra_anastesi,"
                    + "booking_operasi.is_bedah,booking_operasi.is_anastesi,booking_operasi.on_create "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("kd_dokter"), rs.getString("nm_dokter"), order, rs.getString("jenis_operasi"), rs.getString("lokasi_operasi"), rs.getBoolean("is_marking_area") == true ? "Iya" : "Tidak",
                        rs.getBoolean("is_puasa") == true ? "Iya" : "Belum", rs.getString("tgl_puasa"), rs.getBoolean("is_pra_bedah") == true ? "Iya" : "Tidak", rs.getBoolean("is_pra_anastesi") == true ? "Iya" : "Tidak", rs.getString("tgl_pra_anastesi"),
                        rs.getBoolean("is_bedah") == true ? "Iya" : "Tidak", rs.getBoolean("is_anastesi") == true ? "Iya" : "Tidak",rs.getString("on_create")
                    });
                    i++;
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        DTPTgl.requestFocus();
        cekMarking.setSelected(false);
        cekPuasa.setSelected(false);
        cekPraBedah.setSelected(false);
        cekPraAnastesi.setSelected(false);
        cekBedah.setSelected(false);
        cekAnastesi.setSelected(false);
        dlgTglPuasa.setDate(new Date());
        dlgTglPraAnestesi.setDate(new Date());
    }
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            cboJenisOperasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 16));
            cboLokasiOperasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 17));
            cekMarking.setSelected(tbObat.getValueAt(tbObat.getSelectedRow(), 18).toString().equals("Iya") ? true : false);
            cekPuasa.setSelected(tbObat.getValueAt(tbObat.getSelectedRow(), 19).toString().equals("Iya") ? true : false);
            if (cekMarking.isSelected()) {
                cekMarking.setText("Iya");
            } else {
                cekMarking.setText("Belum");
            }
            if (cekPuasa.isSelected()) {
                cekPuasa.setText("Iya");
                Valid.SetTgl2(dlgTglPuasa, tbObat.getValueAt(tbObat.getSelectedRow(), 20).toString());
            } else {
                cekPuasa.setText("Belum");
            }
            cekPraBedah.setSelected(tbObat.getValueAt(tbObat.getSelectedRow(), 21).toString().equals("Iya") ? true : false);
            cekPraAnastesi.setSelected(tbObat.getValueAt(tbObat.getSelectedRow(), 22).toString().equals("Iya") ? true : false);
            if (cekPraAnastesi.isSelected()) {
                Valid.SetTgl2(dlgTglPraAnestesi, tbObat.getValueAt(tbObat.getSelectedRow(), 23).toString());
            }
            cekBedah.setSelected(tbObat.getValueAt(tbObat.getSelectedRow(), 24).toString().equals("Iya") ? true : false);
            cekAnastesi.setSelected(tbObat.getValueAt(tbObat.getSelectedRow(), 25).toString().equals("Iya") ? true : false);
        }
    }
